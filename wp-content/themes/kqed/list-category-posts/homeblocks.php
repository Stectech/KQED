...
$lcp_display_output .= '<div class="homepage-boxes"><div class="container row">';
...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  $lcp_display_output .= '<div class="overlay initial-overlay"><div class="overlay-inner-wrapper">';
